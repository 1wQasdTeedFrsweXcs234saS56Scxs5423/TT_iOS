...
var app = {
    ...
    bindEvents: function() {
        ...
        alert("2 Bind Events Called");
        
        //document.addEventListener('deviceready', this.onDeviceReadyNew, false);
        
        this.onDeviceReadyNew();
