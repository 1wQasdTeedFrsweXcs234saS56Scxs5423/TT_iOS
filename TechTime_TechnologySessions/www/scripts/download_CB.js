...
/* function changePath(elementId,imageType,typeMedia,localPath)
{
    ...
    }else if(typeMedia == 'Technology Conferences' || typeMedia == 'TechnologyConferences'){
        
        $.each(jsonData.techConf, function(index, item){
    ...
    }else if(typeMedia == "Technology Sessions"){
    ...
    } else if(typeMedia == "spotlight")
    {
        $.each(jsonData.spotLight, function(index, item){
